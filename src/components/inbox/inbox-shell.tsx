...
export function InboxShell({
  ...
  return (
    <div className="grid h-[calc(100dvh-260px)] max-h-[calc(100dvh-260px)] grid-cols-1 overflow-hidden rounded-xl border border-border bg-white md:grid-cols-[360px_1fr] xl:grid-cols-[320px_1fr_340px]">
