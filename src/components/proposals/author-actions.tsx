  ...
  return (
    <>
      ...
      <button
        ...
        onClick={del}
        disabled={busy !== null}
        className="inline-flex h-10 items-center gap-1.5 rounded-lg border border-red-400/30 bg-white px-3 text-sm font-semibold text-red-200 hover:bg-red-400/10 disabled:opacity-60"
      >
        {busy === "delete" ? (
          <Loader2 className="h-4 w-4 animate-spin" />
        ) : (
