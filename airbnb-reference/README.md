...
> Research & extraction from 3 open-source Airbnb clones to inform 1DB's Track B UI build.
...
3. **No repo has image carousel, messaging, or trust features** — these are custom builds for 1DB
...
├── flows.md                           ← User flow inventory mapped to 1DB
├── tokens/
...
│   ├── color-palette.json             ← Airbnb colors (DO NOT USE) + 1DB colors
...
└── component-specs/
    ...
    ├── create-listing-wizard.md       ← Multi-step form with 7 steps for 1DB
